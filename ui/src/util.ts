...
export const isSequenceColumn: PColumnPredicate = ({ spec }) => {
  ...
  const isAssemblingFeature = Boolean(
...
export function defaultFilters(tSpec: PTableColumnSpec): unknown | undefined {
  // TODO: update type with defaultFilters feature restoring or remove
  ...
  if (spec.valueType === "String") {
    ...
    try {
      ...
      return {
        type:
          direction === "increasing" ? "number_greaterThanOrEqualTo" : "number_lessThanOrEqualTo",
