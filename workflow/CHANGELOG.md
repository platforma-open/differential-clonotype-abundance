...
- Updated dependencies [ecdbbfc]
  - @platforma-open/milaboratories.run-diff-clonotype-abundance-deseq2-r.software@1.16.3
...
- Updated dependencies [cb53823]
  - @platforma-open/milaboratories.run-diff-clonotype-abundance-deseq2-r.software@1.16.1

## 2.7.2

### Patch Changes

- Updated dependencies [06295e6]
  - @platforma-open/milaboratories.run-diff-clonotype-abundance-deseq2-r.software@1.16.0

## 2.7.1

### Patch Changes

- Updated dependencies [5b12de6]
  - @platforma-open/milaboratories.run-diff-clonotype-abundance-deseq2-r.software@1.15.1
